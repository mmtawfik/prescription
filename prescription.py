...
def create_prescription(patient_name, date, day, birthday, prescription):
    image_path = 'https://raw.githubusercontent.com/mmtawfik/prescription/main/prescription.png' # Replace this with the actual path to your prescription.png file
